    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12 col-sm-6">
                ...
                INNER JOIN files AS f ON f.id=pf.file_id WHERE p.id='$id'; ";
                ...
                ?>
                    <div class="product-image-thumb active"><img src="<?php echo $rowImagenes['web_path'] ?>"></div>
                <?php
                 }
                ?> 
                </div>
            ...
            <div class="col-12 col-sm-6">
                ...
                <hr>
                <h4>Existencia: <?php echo $rowProducto['existencia'] ?></h4>
                ...
                <div class="mt-4">
                    <button class="btn btn-primary btn-lg btn-flat" id="agregarCarrito"
                        ...
                        data-nombre="<?php echo $_REQUEST['nombre'] ?>"
                        data-web_path= "<?php echo $_REQUEST['web_path'] ?>"
                        >
                ...
                <div class="mt-4">
                    Cantidad
                 <input type="number" class="form-control" name="" id="cantidadProducto" value="1">
                </div> 
