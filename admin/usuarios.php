                                 ...
                                 <?php
                                    ...
                                    ?>
                                     <tr>
                                         ...
                                         <td>
                                             <a href="panel.php?modulo=editarUsuario.php?id=<?php echo $_row['id'] ?>" style="margin-right:7px"><i class="fas fa-edit"></i></a>
                                             <a href="panel.php?modulo=usuarios&idBorrar=<?php echo $_row['id'] ?>" class="text-danger borrar"><i class="fas fa-trash"></i></a>
                                         </td>
                                     </tr>
                                    <?php
                                    }
